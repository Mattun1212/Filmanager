 ...
 def self.update_img
   ...
   movies.each do |movie|
    m_url='https://www.unitedcinemas.jp/'+movie.theater+'/film.php?film='+movie.movie_id
        begin
        ...
        Today.find_by(movie_id: movie.movie_id, theater: theater.name).update(img: info[1].strip)
        rescue => e
          puts e
        end
    ...
    m_url='https://www.unitedcinemas.jp/'+today.theater+'/film.php?film='+today.movie_id
        ...
        Today.find_by(movie_id: today.movie_id, theater: theater.name).update(img: info[1].strip)
        rescue => e
          puts e
        end
    end
